...
#qinxuefeng@wind-mobi.com 20160216  begin
ifeq ($(strip $(WIND_PROJECT_NAME)),D260_RELIANCE)
  PRODUCT_COPY_FILES += device/mediatek/common/spn-conf-d260-reliance.xml:system/etc/spn-conf.xml
else
  PRODUCT_COPY_FILES += device/mediatek/common/spn-conf.xml:system/etc/spn-conf.xml
endif
#qinxuefeng@wind-mobi.com 20160216 end
...
ifeq ($(strip $(WIND_SPECIAL_FUNCTIONS_SUPPORT)), yes)
  PRODUCT_PACKAGES +=SpecialFunctions
endif  
ifeq ($(strip $(WIND_GESTURE_WAKEUP_SUPPORT)), yes)
  PRODUCT_PACKAGES +=GestureWakeup
  PRODUCT_PROPERTY_OVERRIDES += ro.wind_gesture_wakeup=1  
endif
#duanzhanyang@wind-mobi.com end
#qinxuefeng@wind-mobi.com 20160216  begin
ifdef WIND_PHONE_NUMBER_MIN_MATCH_LEN
  PRODUCT_PROPERTY_OVERRIDES += ro.wind_min_match_len=$(WIND_PHONE_NUMBER_MIN_MATCH_LEN)
endif
#qinxuefeng@wind-mobi.com 20160216 end
# DTAG DUAL APN
...
# IR-Learning Core
ifneq ($(strip $(MTK_IRTX_SUPPORT)),yes)
...
#qinxuefeng@wind-mobi.com 20151223 begin
ifeq ($(strip $(WIND_SIGNAL_SUPPORT)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.wind_signal_support=1
endif
#qinxuefeng@wind-mobi.com 20151223 end
...
ifeq ($(strip $(MTK_BICR_SUPPORT)), yes)
    ISO_PATH := device/mediatek/common/wind/$(strip $(WIND_PROJECT_NAME))
    ifneq (,$(wildcard $(ISO_PATH)))
        src_files := $(shell ls $(ISO_PATH))
        PRODUCT_COPY_FILES += $(foreach file, $(src_files), $(ISO_PATH)/$(file):system/etc/$(file))
    else
...
PRODUCT_PACKAGES += AdupsFota \
                    AdupsFotaReboot
ifeq ($(strip $(FOTA_UPDATE_FOR_RELIANCE_JIO)), yes)
PRODUCT_PACKAGES += StatisRJIOST
endif
endif
...
#yushengqiang@wind-mobi.com 20160222 begin
ifeq ($(strip $(WIND_NOTIFY_WAKEUP_SCREEN)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.wind_notify_wakeup=1
endif
ifeq ($(strip $(WIND_RUNTIME_SUPPORT)), yes)
  PRODUCT_PACKAGES += WindRuntimeTest
  PRODUCT_PROPERTY_OVERRIDES += ro.wind_runtime_test=1
endif
#yushengqiang@wind-mobi.com 20160222 end
# Add for BRM superset
ifeq ($(strip $(RELEASE_BRM)), yes)
  include device/mediatek/common/releaseBRM.mk
endif

#WOS V2.0 zhangxutong@wind-mobi.com 2015 07 23 begin
ifeq ($(strip $(WOS_APP_WINDPOWERSAVER)), yes)
 PRODUCT_PROPERTY_OVERRIDES += ro.wind_os_app_windpowersaver=1
endif

ifeq ($(strip $(WOS_APP_SMARTCOVER)), yes)
 PRODUCT_PROPERTY_OVERRIDES += ro.wind_os_app_smartcover=1
endif

ifeq ($(strip $(WOS_APP_LOCKSCREEN)), yes)
 PRODUCT_PROPERTY_OVERRIDES += ro.wos_app_lockscreen=1
endif
#A:WOS PrivacyGuard V2.0 machenhui@wind-mobi.com begin 0807
ifeq ($(strip $(WOS_APP_PRIVACYGUARD)), yes)
 PRODUCT_PROPERTY_OVERRIDES += ro.wos_app_privacyguard=1
endif
#A:WOS PrivacyGuard V2.0 machenhui@wind-mobi.com end 0807

ifeq ($(strip $(WOS_APP_CAMERA)), yes)
 PRODUCT_PROPERTY_OVERRIDES += ro.wos_app_camera=1
endif
#WOS V2.0 machenhui@wind-mobi.com 2015 12 08 begin
ifeq ($(strip $(WOS_APP_CAMERA_BACK)), yes)
 PRODUCT_PROPERTY_OVERRIDES += ro.wos_app_camera_back=1
endif
#WOS V2.0 machenhui@wind-mobi.com 2015 12 08 end
ifeq ($(strip $(WOS_APP_LAUNCHER)), yes)
 PRODUCT_PROPERTY_OVERRIDES += ro.wos_app_launcher=1
endif
#WOS V2.0 zhangxutong@wind-mobi.com 2015 07 23 end
...
#A:WOS WOS_FingerPrint liaoyuhuan@wind-mobi.com 160418 begin
ifeq ($(strip $(WOS_APP_FINGERSTART_SUPPORT)), yes)
  PRODUCT_PACKAGES += WOSFingerStart
  PRODUCT_PROPERTY_OVERRIDES += ro.wos_app_fingerstart=1
endif
#WOS WOS_FingerPrint liaoyuhuan@wind-mobi.com 160418 end
#WOS WOS_AppLock liaoyuhuan@wind-mobi.com 160418 begin
ifeq ($(strip $(WOS_APP_APPLOCK_SUPPORT)), yes)
  PRODUCT_PACKAGES += WOSAppLock
  PRODUCT_PROPERTY_OVERRIDES += ro.wos_app_applock=1
endif
#WOS WOS_AppLock liaoyuhuan@wind-mobi.com 160418 end

#duanzhanyang@wind-mobi.com begin
ifeq ($(strip $(WIND_CALL_RECORD_TIME)), yes)
 PRODUCT_PROPERTY_OVERRIDES += ro.wind_call_record_time=1
endif
#duanzhanyang@wind-mobi.com end

#jinyangyang@wind-mobi.com 20160318 begin
ifeq ($(strip $(WIND_PROJECT_D260_RELIANCE)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.wind_project_d260_reliance=1
endif
#jinyangyang@wind-mobi.com 20160318 end
#WOS WOS_lovelyfonts machenhui@wind-mobile.com	0128 begin
ifeq ($(strip $(LOVELYFONTS_SUPPORT)), yes)
 PRODUCT_PROPERTY_OVERRIDES += ro.lovelyfonts_support=1
endif
#WOS WOS_lovelyfonts machenhui@wind-mobile.com	0128 end
#gongshouwei@wind-mobi.com add BatteryPercent begin
ifeq ($(strip $(WIND_BATTERYLEVEL_SHOW)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.batterylevel.show=1
endif
#gongshouwei@wind-mobi.com add BatteryPercent end
